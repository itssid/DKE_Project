...
def game_controls():
    ...
    while gcont:
        ...
        message_to_screen("CONTROLS",purple,-290,size="large")
        message_to_screen("PLAYER 1",black,-240,size="large")
        message_to_screen("FIRE: Spacebar",black,-200,size="medium")
        message_to_screen("Move Turret: W and S ",black,-170,size="medium")
        message_to_screen("Move Tank: A and D",black,-140,size="medium")
        message_to_screen("Adjust Power: Q to increase and E to decrease",black,-110,size="medium")
